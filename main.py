...
=======
        concave_points_mean = float(myDict['concave points_mean'])
>>>>>>> 447f8cb7052d1bf3a626d19db087db50a2f0f4c5
...
=======
        concave_points_se = float(myDict['concave points_se'])
>>>>>>> 447f8cb7052d1bf3a626d19db087db50a2f0f4c5
...
=======
        concave_points_worst = float(myDict['concave points_worst'])
        symmetry_worst = float(myDict['symmetry_worst'])
        fractal_dimension_worst = float(myDict['fractal_dimension_worst'])
